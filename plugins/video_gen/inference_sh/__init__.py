...
FAMILIES: Dict[str, Dict[str, Any]] = {
    ...
    "p-video": {
        ...
        "speed": "~15-30s",
        "price": "cheap",
        "strengths": "Fastest and cheapest video generation. Text-to-video only.",
        "tier": "cheap",
        "text_app": "p-video",
        "image_app": None,
        "aspect_ratios": None,
    ...
    "seedance-2.0": {
        ...
        "tier": "premium",
        "text_app": "seedance/2.0",
        "image_app": "seedance/2.0",
    ...
    "wan-2.5": {
        ...
        "tier": "premium",
        "text_app": "wan/2.5-t2v",
        "image_app": "wan/2.5-i2v",
    ...
    "happyhorse": {
        ...
        "tier": "premium",
        "text_app": "happyhorse/1.0",
        "image_app": "happyhorse/1.0",
        "aspect_ratios": None,
        "resolutions": None,
        "durations": None,
        "audio": False,
...
class InferenceShVideoGenProvider(VideoGenProvider):
    ...
    def get_setup_schema(self) -> Dict[str, Any]:
        return {
            ...
            "badge": "paid",
            "tag": (
                "Veo 3.1, Seedance 2.0, Wan 2.5, HappyHorse, Grok Video, P-Video "
